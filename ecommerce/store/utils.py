...
def cookieCart(request):
    """
    Returns an dictionary outlining a cart(from guest cookie 'cart'): cartItems, items, and order; using
...
def guestOrder(request, data):
    """
    Creates a customer and order in database based on loaded guest cart cookie 'data'.
